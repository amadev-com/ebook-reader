...
// runChapters displays the per-chapter pipeline status table for a project.
// It returns an error if chapters cannot be loaded or the project contains no chapters.
